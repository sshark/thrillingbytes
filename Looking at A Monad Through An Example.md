...
Effect is not side effect. Effect in this context is like a *container* or a container with some capabilities. Simple container like `Opton` is a list with the maximum capacity of 1 element or empty. With this `Option` effect we can let the caller know the the function execution status. The is a success or 

<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEzNzY1OTEyMzEsLTIxMTg0NDQ4MTZdfQ
==
-->